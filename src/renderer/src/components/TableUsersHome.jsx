...
export default function UserTable() {
  ...
  return (
    <>
      {loadingGet  ? (
        <div className="w-full  flex items-center justify-center col-span-1 h-[300px] sm:col-span-2">
        ...
        users && (
          <Table
            ...
            className="border-3 border-gray-400 rounded-lg col-span-1    lg:max-h-[352px] sm:col-span-2 overflow-y-auto "
          >
